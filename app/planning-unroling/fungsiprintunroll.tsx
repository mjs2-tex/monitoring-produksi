// fungsiprintUnrolling.tsx
import React from 'react';
import moment from 'moment';
import "moment/locale/id"; // Import locale Indonesia
moment.locale("id");      // Set global ke bahasa Indonesia

export default function UnrollingReport({ kodePlanning, all }: { kodePlanning: string, all?: any }) {
  ...
  return (
    <div className="report-container">
      ...
      <div className="flex flex-col ">
        <h1>
          PLANNING UNROLLING {moment(all.tgl_planning_awal).format("dddd, D MMMM YYYY")}
