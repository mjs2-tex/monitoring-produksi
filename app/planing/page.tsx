...
import DyeingReport  from "./fungsiprintdyeing";
    ...
    <div className="w-full h-[calc(100vh-70px)] flex flex-col p-4 gap-2 bg-slate-50 text-slate-800">
      {selectedPrintKode && (
        <div className="hidden print:block">
          <DyeingReport kodePlanning={selectedPrintKode} all={selectedPrintALL} />
        </div>
      )}
      ...
      <div className="w-full h-full bg-white rounded-2xl border border-slate-200 p-5 flex flex-col shadow-sm overflow-hidden print:hidden">
