...
const DeliveryBatchTable = () => {
  ...
  const columns = useMemo(() => [
    ...
    columnHelper.accessor("sisa_hari", {
      header: "HARI",
      cell: (info) => {
...
export default DeliveryBatchTable;